...
//  private ArrayList participants;
    ...
    private JButton btnBekreftDato;
    ...
    public void initGUI() throws SQLException {
        ...
        combo.setBounds(123, 500, 200, 35);
    ...
    class Save implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            event = new EventModel(txtDescription.getText(), formatDate(calendar.getDate()), getStartStamp(), getEndStamp(), memberList.getSelectedPersons());
        }
    }
}//class
